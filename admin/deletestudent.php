<div class="main" style="width:850px;position:absolute;left:20%;top:20%;background:rgba(0,0,0,0.8);
    color:white;">
<form action="#" method="post">
        <div class="row-main">
                <div class="panel-heading">
                   <div class="panel-title text-center">
                        <h1 style="position: relative; right: 200px;" class="title">Delete Student Information</h1>
                    </div>
                </div> 
                <div class="container">
                <div class="row">
